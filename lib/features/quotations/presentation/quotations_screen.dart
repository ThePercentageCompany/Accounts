                        ...
                        return Padding(
                          ...
                          child: ChoiceChip(
                            avatar: Icon(
                              f['icon'] as IconData,
                              size: 14,
                              color: isSelected ? Colors.white : AppTheme.zohoBlue,
                            ),
                            label: Text(
                              '${f['label']} ($count)',
                              style: TextStyle(
                            ...
                            selected: isSelected,
                            selectedColor: AppTheme.zohoBlue,
                            backgroundColor: isDark ? AppTheme.zohoDarkSurface : AppTheme.zohoLightSurface,
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(AppTheme.buttonRadiusVal),
                              side: BorderSide(
                                color: isSelected ? AppTheme.zohoBlue : (isDark ? AppTheme.zohoDarkBorder : AppTheme.zohoLightBorder),
                                width: 0.8,
                              ),
                            ),
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: AppTheme.zohoBlue.withValues(alpha: isDark ? 0.2 : 0.12),
