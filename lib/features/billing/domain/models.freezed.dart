...
mixin _$Company {
 ...
 String get name; String get address; String get phone; String get email; String get trn; String get prefix; String get accountHolder; String get bank; String get accountNumber; String get iban; String get notes; String get terms; String get logo; String get logoDriveUrl; List<Map<String, dynamic>> get shareholders; int get version;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Company&&(identical(other.name, name) || other.name == name)&&(identical(other.address, address) || other.address == address)&&(identical(other.phone, phone) || other.phone == phone)&&(identical(other.email, email) || other.email == email)&&(identical(other.trn, trn) || other.trn == trn)&&(identical(other.prefix, prefix) || other.prefix == prefix)&&(identical(other.accountHolder, accountHolder) || other.accountHolder == accountHolder)&&(identical(other.bank, bank) || other.bank == bank)&&(identical(other.accountNumber, accountNumber) || other.accountNumber == accountNumber)&&(identical(other.iban, iban) || other.iban == iban)&&(identical(other.notes, notes) || other.notes == notes)&&(identical(other.terms, terms) || other.terms == terms)&&(identical(other.logo, logo) || other.logo == logo)&&(identical(other.logoDriveUrl, logoDriveUrl) || other.logoDriveUrl == logoDriveUrl)&&const DeepCollectionEquality().equals(other.shareholders, shareholders)&&(identical(other.version, version) || other.version == version));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,address,phone,email,trn,prefix,accountHolder,bank,accountNumber,iban,notes,terms,logo,logoDriveUrl,const DeepCollectionEquality().hash(shareholders),version);

@override
String toString() {
  return 'Company(name: $name, address: $address, phone: $phone, email: $email, trn: $trn, prefix: $prefix, accountHolder: $accountHolder, bank: $bank, accountNumber: $accountNumber, iban: $iban, notes: $notes, terms: $terms, logo: $logo, logoDriveUrl: $logoDriveUrl, shareholders: $shareholders, version: $version)';
}
...
@useResult
$Res call({
 String name, String address, String phone, String email, String trn, String prefix, String accountHolder, String bank, String accountNumber, String iban, String notes, String terms, String logo, String logoDriveUrl, List<Map<String, dynamic>> shareholders, int version
});
...
/// Create a copy of Company
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? address = null,Object? phone = null,Object? email = null,Object? trn = null,Object? prefix = null,Object? accountHolder = null,Object? bank = null,Object? accountNumber = null,Object? iban = null,Object? notes = null,Object? terms = null,Object? logo = null,Object? logoDriveUrl = null,Object? shareholders = null,Object? version = null,}) {
  return _then(_self.copyWith(
...
as String,logoDriveUrl: null == logoDriveUrl ? _self.logoDriveUrl : logoDriveUrl // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String address,  String phone,  String email,  String trn,  String prefix,  String accountHolder,  String bank,  String accountNumber,  String iban,  String notes,  String terms,  String logo,  String logoDriveUrl,  List<Map<String, dynamic>> shareholders,  int version)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Company() when $default != null:
return $default(_that.name,_that.address,_that.phone,_that.email,_that.trn,_that.prefix,_that.accountHolder,_that.bank,_that.accountNumber,_that.iban,_that.notes,_that.terms,_that.logo,_that.logoDriveUrl,_that.shareholders,_that.version);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String address,  String phone,  String email,  String trn,  String prefix,  String accountHolder,  String bank,  String accountNumber,  String iban,  String notes,  String terms,  String logo,  String logoDriveUrl,  List<Map<String, dynamic>> shareholders,  int version)  $default,) {final _that = this;
switch (_that) {
case _Company():
return $default(_that.name,_that.address,_that.phone,_that.email,_that.trn,_that.prefix,_that.accountHolder,_that.bank,_that.accountNumber,_that.iban,_that.notes,_that.terms,_that.logo,_that.logoDriveUrl,_that.shareholders,_that.version);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String address,  String phone,  String email,  String trn,  String prefix,  String accountHolder,  String bank,  String accountNumber,  String iban,  String notes,  String terms,  String logo,  String logoDriveUrl,  List<Map<String, dynamic>> shareholders,  int version)?  $default,) {final _that = this;
switch (_that) {
case _Company() when $default != null:
return $default(_that.name,_that.address,_that.phone,_that.email,_that.trn,_that.prefix,_that.accountHolder,_that.bank,_that.accountNumber,_that.iban,_that.notes,_that.terms,_that.logo,_that.logoDriveUrl,_that.shareholders,_that.version);case _:
  return null;
...
@override@JsonKey() final  String logoDriveUrl;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Company&&(identical(other.name, name) || other.name == name)&&(identical(other.address, address) || other.address == address)&&(identical(other.phone, phone) || other.phone == phone)&&(identical(other.email, email) || other.email == email)&&(identical(other.trn, trn) || other.trn == trn)&&(identical(other.prefix, prefix) || other.prefix == prefix)&&(identical(other.accountHolder, accountHolder) || other.accountHolder == accountHolder)&&(identical(other.bank, bank) || other.bank == bank)&&(identical(other.accountNumber, accountNumber) || other.accountNumber == accountNumber)&&(identical(other.iban, iban) || other.iban == iban)&&(identical(other.notes, notes) || other.notes == notes)&&(identical(other.terms, terms) || other.terms == terms)&&(identical(other.logo, logo) || other.logo == logo)&&(identical(other.logoDriveUrl, logoDriveUrl) || other.logoDriveUrl == logoDriveUrl)&&const DeepCollectionEquality().equals(other._shareholders, _shareholders)&&(identical(other.version, version) || other.version == version));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,address,phone,email,trn,prefix,accountHolder,bank,accountNumber,iban,notes,terms,logo,logoDriveUrl,const DeepCollectionEquality().hash(_shareholders),version);
