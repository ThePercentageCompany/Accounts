...
class _CompanyEditorState extends State<CompanyEditor> {
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Shareholders & Capital Equity Card
                  Card(
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(16),
                      side: BorderSide(color: isDark ? const Color(0x20FFFFFF) : const Color(0x10000000), width: 0.8),
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        Container(
                                          ...
                                          child: const Icon(CupertinoIcons.money_dollar_circle_fill, color: Color(0xFF8B5CF6), size: 18),
                                        ),
                                    ...
                                    Text(
                                      'Manage partners, equity ownership percentages, and invested capital contributions.',
                                      style: TextStyle(
                                        fontSize: 12.5,
                                        color: isDark ? AppTheme.iosDarkTextSecondary : AppTheme.iosLightTextSecondary,
                                      ),
                              ...
                              Wrap(
                                ...
                                children: [
                                  FilledButton.icon(
                                    onPressed: () => _editShareholder(context),
                                  ...
                                  OutlinedButton.icon(
                                    onPressed: shareholders.isEmpty ? null : () => _recordCapitalContribution(),
                                    icon: const Icon(CupertinoIcons.money_dollar, size: 14, color: Color(0xFF8B5CF6)),
                                    label: const Text('Record Capital', style: TextStyle(color: Color(0xFF8B5CF6))),
                              ...
                              children: [
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'AED ${totalInvestedCapital.toStringAsFixed(2)}',
                                          style: const TextStyle(
                                            fontSize: 17,
                                            fontWeight: FontWeight.w800,
                                            color: AppTheme.zohoGreen,
                                          ),
                                        ),
                                      ],
                                    ),
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        const SizedBox(height: 2),
                                        Text(
                                          '${totalSharePercent.toStringAsFixed(1)}%',
                                          style: TextStyle(
                                            fontSize: 17,
                                            fontWeight: FontWeight.w800,
                                            color: totalSharePercent == 100.0
                                                ? AppTheme.zohoGreen
                                                : (totalSharePercent > 100.0 ? AppTheme.zohoRed : const Color(0xFFF59E0B)),
                                          ),
                                        ),
                                      ],
                                    ),
                                ...
                                ClipRRect(
                                  ...
                                  child: LinearProgressIndicator(
                                    value: (totalSharePercent / 100.0).clamp(0.0, 1.0),
                                    minHeight: 6,
                                    backgroundColor: isDark ? const Color(0xFF334155) : const Color(0xFFE2E8F0),
                                    valueColor: AlwaysStoppedAnimation<Color>(
                                      totalSharePercent == 100.0
                                          ? AppTheme.zohoGreen
                                          : (totalSharePercent > 100.0 ? AppTheme.zohoRed : const Color(0xFF8B5CF6)),
                                    ),
                                  ),
                                ),
                              ],
                          ...
                          if (shareholders.isEmpty)
                            Container(
                              ...
                              child: Column(
                                children: [
                                  const Icon(CupertinoIcons.person_3_fill, size: 36, color: Colors.grey),
                                  const SizedBox(height: 8),
                                  const Text('No Shareholders Added', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 14)),
                                  const SizedBox(height: 4),
                                  Text(
                                    'Add company partners, founders, or investors to track equity allocation and capital contributions.',
                                  ...
                                  FilledButton.tonalIcon(
                                    onPressed: () => _editShareholder(context),
                                    icon: const Icon(CupertinoIcons.plus, size: 14),
                                    label: const Text('Add First Shareholder'),
                                  ),
                                ],
                              ),
                            )
                            ...
                            for (int i = 0; i < shareholders.length; i++) ...[
                              _buildShareholderCard(shareholders[i], i, isDark),
                              if (i < shareholders.length - 1) const SizedBox(height: 10),
                            ],
                        ],
                      ),
                    ),
  ...
  List<Map<String, dynamic>> get shareholders {
    final list = data['shareholders'];
    if (list is List) {
  ...
  double get totalInvestedCapital {
    ...
    for (final s in shareholders) {
      final amt = double.tryParse(s['investedAmount']?.toString().replaceAll(',', '') ?? '0') ?? 0.0;
      sum += amt;
    }
    return sum;
  }

  double get totalSharePercent {
    double sum = 0.0;
    for (final s in shareholders) {
      final p = double.tryParse(s['sharesPercent']?.toString().replaceAll('%', '') ?? '0') ?? 0.0;
      sum += p;
    }
    return sum;
  }

  Future<void> _editShareholder(BuildContext context, [Map<String, dynamic>? old, int? index]) async {
    final nameCtrl = TextEditingController(text: old?['name']?.toString() ?? '');
    final roleCtrl = TextEditingController(text: old?['role']?.toString() ?? 'Partner & Shareholder');
    final sharesCtrl = TextEditingController(text: old?['sharesPercent']?.toString() ?? '');
    final amountCtrl = TextEditingController(text: old?['investedAmount']?.toString() ?? '');
    final dateCtrl = TextEditingController(text: old?['date']?.toString() ?? DateTime.now().toIso8601String().substring(0, 10));
    final emailCtrl = TextEditingController(text: old?['email']?.toString() ?? '');
    final phoneCtrl = TextEditingController(text: old?['phone']?.toString() ?? '');
    final notesCtrl = TextEditingController(text: old?['notes']?.toString() ?? '');
    ...
    final saved = await showDialog<Map<String, dynamic>>(
      ...
      builder: (ctx) {
        return AlertDialog(
          title: Text(old == null ? 'Add Shareholder / Partner' : 'Edit Shareholder'),
          content: SizedBox(
            width: 500,
            child: SingleChildScrollView(
              child: Form(
                  ...
                  children: [
                    TextFormField(
                      ...
                      decoration: const InputDecoration(
                        labelText: 'Shareholder / Partner Name *',
                    ...
                    TextFormField(
                      ...
                      decoration: const InputDecoration(
                        ...
                        hintText: 'e.g. Managing Partner, Director, Investor',
                        ...
                        Expanded(
                          child: TextFormField(
                            ...
                            decoration: const InputDecoration(
                              ...
                              hintText: 'e.g. 50.0',
                              suffixText: '%',
                              prefixIcon: Icon(CupertinoIcons.chart_pie, size: 18),
                            ),
                            validator: (v) {
                              if (v == null || v.trim().isEmpty) return 'Required';
                              final n = double.tryParse(v.trim());
                              if (n == null || n <= 0 || n > 100) return 'Enter 0.1 - 100';
                              return null;
                            },
                          ),
                        ),
                    ...
                    TextFormField(
                      ...
                      decoration: const InputDecoration(
                        labelText: 'Notes / Agreement Reference',
              ...
              onPressed: () {
                if (formKey.currentState!.validate()) {
                  Navigator.pop(ctx, {
                    ...
                    'sharesPercent': sharesCtrl.text.trim(),
                    'investedAmount': amountCtrl.text.trim(),
    ...
    if (saved != null) {
      setState(() {
        final current = shareholders;
        if (index != null && index >= 0 && index < current.length) {
          current[index] = saved;
        } else {
          current.add(saved);
        }
        data['shareholders'] = current;
      });
    }
  }

  Future<void> _recordCapitalContribution() async {
    if (shareholders.isEmpty) return;
    String selectedShareholderId = shareholders.first['id']?.toString() ?? '';
      ...
      builder: (ctx) {
        return StatefulBuilder(
          builder: (context, setDlgState) {
            return AlertDialog(
              title: const Text('Record Capital Contribution'),
              content: SizedBox(
                width: 480,
                child: SingleChildScrollView(
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        DropdownButtonFormField<String>(
                          ...
                          decoration: const InputDecoration(
                            labelText: 'Contributing Shareholder *',
                            prefixIcon: Icon(CupertinoIcons.person_crop_circle_badge_checkmark, size: 18),
                          ),
                          items: [
                            for (final s in shareholders)
                              DropdownMenuItem(
                                value: s['id']?.toString(),
                                child: Text('${s['name']} (${s['sharesPercent']}%)'),
                              ),
                          ],
                          onChanged: (v) {
                            if (v != null) setDlgState(() => selectedShareholderId = v);
                          },
                        ),
                        const SizedBox(height: 12),
                        Row(
                            ...
                            Expanded(
                              ...
                              child: TextFormField(
                                ...
                                validator: (v) {
                                  if (v == null || v.trim().isEmpty) return 'Required';
                                  final n = double.tryParse(v.trim().replaceAll(',', ''));
                                  if (n == null || n <= 0) return 'Must exceed 0';
                                  return null;
                                },
                              ),
                            ),
                          ...
                          children: [
                            Expanded(
                              child: DropdownButtonFormField<String>(
                                ...
                                onChanged: (v) {
                                  if (v != null) setDlgState(() => account = v);
                                },
                              ),
                            ),
                            const SizedBox(width: 12),
                        ...
                        TextFormField(
                          controller: notesCtrl,
                          decoration: const InputDecoration(
                            labelText: 'Notes / Capital Injection Purpose',
                            prefixIcon: Icon(CupertinoIcons.doc_plaintext, size: 18),
                          ),
                          maxLines: 2,
                        ),
    ...
    if (confirmed == true) {
      final extraAmt = double.tryParse(amountCtrl.text.trim().replaceAll(',', '')) ?? 0.0;
      final current = shareholders;
      final targetIdx = current.indexWhere((s) => s['id'] == selectedShareholderId);
      if (targetIdx != -1) {
        final prevAmt = double.tryParse(current[targetIdx]['investedAmount']?.toString().replaceAll(',', '') ?? '0') ?? 0.0;
        final newAmt = prevAmt + extraAmt;
        current[targetIdx]['investedAmount'] = newAmt.toStringAsFixed(2);
        final partnerName = current[targetIdx]['name']?.toString() ?? 'Shareholder';
        ...
        // Sync to Office financial cashbook if OfficeCubit is present
        try {
          final officeCubit = context.read<OfficeCubit>();
          await officeCubit.run('financeSave', {
            'id': const Uuid().v4(),
            'kind': 'capital',
            'party': partnerName,
            ...
            'notes': notesCtrl.text.trim().isNotEmpty
                ? notesCtrl.text.trim()
                : 'Capital contribution by $partnerName',
          });
        } catch (_) {}
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Recorded AED ${amountCtrl.text} capital contribution for $partnerName.')),
        );
      }
    }
  }

  Widget _buildShareholderCard(Map<String, dynamic> s, int index, bool isDark) {
    final name = s['name']?.toString() ?? 'Shareholder';
    final role = s['role']?.toString().isNotEmpty == true ? s['role'].toString() : 'Partner & Shareholder';
    final shares = s['sharesPercent']?.toString() ?? '0';
    final invested = s['investedAmount']?.toString() ?? '0.00';
    final date = s['date']?.toString() ?? '';
    final email = s['email']?.toString() ?? '';
    final phone = s['phone']?.toString() ?? '';
    final notes = s['notes']?.toString() ?? '';

    final initials = name.trim().split(RegExp(r'\s+')).map((w) => w.isNotEmpty ? w[0] : '').take(2).join().toUpperCase();
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Container(
                ...
                child: Center(
                  child: Text(
                    initials.isNotEmpty ? initials : 'SH',
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      children: [
                        if (date.isNotEmpty)
                          Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              const Icon(CupertinoIcons.calendar, size: 12, color: Colors.grey),
                              const SizedBox(width: 4),
                              Text('Joined: $date', style: TextStyle(fontSize: 11.5, color: isDark ? AppTheme.iosDarkTextSecondary : AppTheme.iosLightTextSecondary)),
                            ],
                          ),
                        if (email.isNotEmpty)
                          Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              const Icon(CupertinoIcons.mail, size: 12, color: Colors.grey),
                              const SizedBox(width: 4),
                              Text(email, style: TextStyle(fontSize: 11.5, color: isDark ? AppTheme.iosDarkTextSecondary : AppTheme.iosLightTextSecondary)),
                            ],
                          ),
                        if (phone.isNotEmpty)
                          Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              const Icon(CupertinoIcons.phone, size: 12, color: Colors.grey),
                              const SizedBox(width: 4),
                              Text(phone, style: TextStyle(fontSize: 11.5, color: isDark ? AppTheme.iosDarkTextSecondary : AppTheme.iosLightTextSecondary)),
                            ],
                          ),
                      ],
                    ),
                    if (notes.isNotEmpty) ...[
                      ...
                      Text(
                        notes,
                        style: TextStyle(fontSize: 11.5, fontStyle: FontStyle.italic, color: isDark ? AppTheme.iosDarkTextSecondary : AppTheme.iosLightTextSecondary),
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
                      ),
                    ],
              ...
              Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 4),
                  Text(
                    'AED ${double.tryParse(invested.replaceAll(',', ''))?.toStringAsFixed(2) ?? invested}',
                    style: const TextStyle(
                      fontSize: 14.5,
                      fontWeight: FontWeight.w800,
                      color: AppTheme.zohoGreen,
          ...
          Row(
            ...
            children: [
              TextButton.icon(
                onPressed: () => _editShareholder(context, s, index),
                icon: const Icon(CupertinoIcons.pencil, size: 13),
                label: const Text('Edit Details', style: TextStyle(fontSize: 12)),
              ),
              const SizedBox(width: 6),
              IconButton(
                tooltip: 'Delete Shareholder',
                icon: const Icon(CupertinoIcons.trash, size: 14, color: AppTheme.pastelRose),
                onPressed: () async {
                  final yes = await showDialog<bool>(
                    context: context,
                    builder: (ctx) => AlertDialog(
                      title: const Text('Delete Shareholder?'),
                      content: Text('Are you sure you want to remove $name from company shareholders?'),
                      actions: [
                        TextButton(onPressed: () => Navigator.pop(ctx, false), child: const Text('Cancel')),
                        FilledButton(
                          onPressed: () => Navigator.pop(ctx, true),
