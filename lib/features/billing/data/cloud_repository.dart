...
class CloudRepository implements BillingRepository {
  ...
  @override Future<void> deleteCustomer(String customerId) async { await command('deleteCustomer', {'id': customerId}); }
  ...
  @override Future<void> deleteDraft(String invoiceId) async { await command('deleteDraft', {'id': invoiceId}); }
